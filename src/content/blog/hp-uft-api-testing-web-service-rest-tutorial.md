...
Manual Testing:
  Tester → Jalankan test case → Catat hasil → Ulangi setiap build
  Waktu: lama, error-prone, tidak konsisten

Automated Testing (UFT):
  Script → Jalankan otomatis → Report otomatis → Ulangi setiap build
  Waktu: cepat, konsisten, reproducible
...
├──────────────────┬──────────────────────────────┬──────────────┤
│ SOLUTION         │                              │ PROPERTIES   │
│ EXPLORER         │   CANVAS (Test Flow)         │ PANE         │
│                  │   ┌──────────────────────┐   │              │
│ Tests/           │   │  Step 1              │   │ Input/       │
│ Components/      │   │  Step 2              │   │ Checkpoints  │
│ User Code        │   │  Step 3              │   │              │
│                  │   └──────────────────────┘   │ General      │
├──────────────────┤                              │ Tab          │
│ TOOLBOX          │                              │              │
