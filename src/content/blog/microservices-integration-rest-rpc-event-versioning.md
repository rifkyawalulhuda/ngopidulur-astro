...
ASYNCHRONOUS (Event/Message):
  Client ──────event/message──► Message Broker
...
"Pelanggan mendaftar" → Event Bus
                              │
              ┌───────────────┼──────────────┐
              │               │              │
              ▼               ▼              ▼
       Email Service   Loyalty Service   Analytics
       (kirim welcome) (buat akun)      (track event)

Setiap service tahu "apa yang harus dilakukan saat X terjadi"
Tidak ada koordinator central
```
...
Response 200: {"id": 123, "name": "Rifky Awalul", ...}
...
External Services ──────────────────────────────────────────
Internal Services ─► [Your CRM Service] ─► CRM COTS Product
Direct DB Access ─  (hides complexity)
